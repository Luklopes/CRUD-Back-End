...
------------------------- | ----------------- | --------------------- | 
/api/clientes             |       GET         | Selecionar Todos      | 
/api/clientes             |       POST        | Criar Cliente         | 
/api/clientes/:cliente_id |       GET         | Selecionar Por Id     | 
/api/clientes/:cliente_id |       PUT         | Atualizar Por Id      |    
/api/clientes/:cliente_id |       DELETE      | Excluir Por Id        |
